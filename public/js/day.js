...
l = ["非常抱歉，因为不可控原因，博客将于明天停止运营！", "好消息，日本没了！", "美国垮了，原因竟然是川普！", "微软垮了！", "你的电脑已经过载，建议立即关机！", "一分钟有61秒哦", "B站老年版上线了！！！"]
...
if (m == 5 && dd == 4) {//青年节
    if (sessionStorage.getItem("isPopupWindow") != "1") {
        Swal.fire("今天是五四青年节，让我们记住那些为国家存亡而奋斗的青年！");
        sessionStorage.setItem("isPopupWindow", "1");
    }
}
if (m == 7 && dd == 1) {//建党节
...
if (m == 7 && dd == 12){
    if(sessionStorage.getItem("isPopupWindow") != "1"){
        Swal.fire("今天是站长" + (y - 2013).toString() + "岁生日哦！");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
